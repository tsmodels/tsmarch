...
Rcpp::List dcc_dynamic_normal(const arma::vec alpha, const arma::vec gamma,
                              const arma::vec beta, const arma::mat z,
                              Rcpp::IntegerVector dccorder);
Rcpp::List dcc_dynamic_student(const arma::vec alpha, const arma::vec gamma,
...
Rcpp::List dcc_constant_student_filter(double shape, const arma::mat z,
                                       const int n_update);
Rcpp::List dcc_dynamic_normal_filter(const arma::vec alpha, const arma::vec gamma,
                                     const arma::vec beta, const arma::mat z,
                                     Rcpp::IntegerVector dccorder,
                                     const int n_update);
...
Rcpp::List dcc_constant_simulate(const double shape, const arma::mat R,
                                 const arma::mat std_noise, const int timesteps,
                                 Rcpp::String distribution);
double adcc_constraint(const arma::vec alpha, const arma::vec gamma,
                       const arma::vec beta, double shape, const arma::mat z,
                       Rcpp::IntegerVector dccorder);
